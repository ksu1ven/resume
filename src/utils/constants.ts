...
export const EXPERIENCE: ExperienceItem[] = [
    {
        ...
        description:
            'Разработка веб-приложений на Vue, Tailwind и FSD. Решала задачи: вёрстка под все устройства,интеграция бэка через axios и Swagger, реал-тайм чат на WebSocket, платежи Telegram, эквайринг CloudPayments с сохранением карт и токенизацией, интернационализация (i18n), подключение TON-кошелька, запуск игр Unity в Web, карты Leafletи Yandex, диаграммы Chart.js, слайдеры на Swiper, анимация на gsap, имитация браузерного зума с логикой границ и др.',
    },
    {
        img: catProgrammer,
        profession: 'Frontend разработчик',
